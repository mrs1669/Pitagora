void ikusa(){  
  ...
  mass_no_archer_r(70+x12,590,50);
  mass_no_archer_r(100+x12,585,50);
  mass_no_archer_r(130+x12,580,50);
  mass_no_archer_r(160+x12,575,50);
  mass_no_archer_r(190+x12,570,50);
  mass_no_archer_r(220+x12,565,50);
  mass_on_archer_r(70+x12,185,50);
  mass_on_archer_r(100+x12,190,50);
  mass_on_archer_r(130+x12,195,50);
  mass_on_archer_r(160+x12,200,50);
  mass_on_archer_r(190+x12,205,50);
  mass_on_archer_r(220+x12,210,50); //left archer
  ...
  mass_no_archer_l(1150+x11,200+y11,50);
  mass_no_archer_l(1180+x11,195+y11,50);
  mass_no_archer_l(1210+x11,190+y11,50);
  mass_no_archer_l(1240+x11,185+y11,50);
  mass_no_archer_l(1270+x11,180+y11,50);
  mass_no_archer_l(1300+x11,175+y11,50);
  mass_on_archer_l(1150+x11,565-y11,50);
  mass_on_archer_l(1180+x11,570-y11,50);
  mass_on_archer_l(1210+x11,575-y11,50);
  mass_on_archer_l(1240+x11,580-y11,50);
  mass_on_archer_l(1270+x11,585-y11,50);
  mass_on_archer_l(1300+x11,590-y11,50); //right archer
  
  mass_ku_swordman_l(1010+x11,390,50);
  mass_ku_swordman_l(1040+x11,390,50);
  mass_ku_swordman_l(1070+x11,390,50);
  mass_ku_swordman_l(1100+x11,390,50);
